...
1. If there is no match in postal code and hence no corresponding project name, I will get all the possible project names using the postal code in the URA geocoding API
